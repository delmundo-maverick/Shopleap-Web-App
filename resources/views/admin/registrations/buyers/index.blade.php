            ...
            <div id="modalBody" class="hidden space-y-5 p-6">
                ...
                <div class="rounded-2xl border border-white/60 bg-white/60 p-4">
                    ...
                    <a id="modalIdLink" href="#" target="_blank"
                        ...
                        <p class="bg-white/70 px-2 py-1.5 text-center text-xs font-semibold text-charcoal/70">Valid ID
                            — click to view
                            full</p>
                    </a>
                </div>
                ...
                <div id="modalPendingActions"
                    class="hidden space-y-3 rounded-2xl border border-white/60 bg-ice-blue/60 p-4">
