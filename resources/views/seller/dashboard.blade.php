...
<body class="min-h-screen bg-[#F0FAFA] text-charcoal">
            ...
            <header class="flex h-20 items-center justify-between border-b border-light-gray bg-white px-6">
                ...
                <div class="flex items-center gap-3">
                    <button type="button" data-sidebar-toggle
                        class="rounded-lg p-2 text-charcoal/60 transition hover:bg-[#E6F7F5] hover:text-[#0D9488] lg:hidden">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button
                        class="relative rounded-full p-2 text-charcoal/60 transition hover:bg-[#E6F7F5] hover:text-[#0D9488]">
                    ...
                    <div class="flex items-center gap-2.5">
                        <div
                            class="flex h-9 w-9 items-center justify-center rounded-full bg-[#0D9488] text-sm font-bold text-white">
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="rounded-2xl border border-light-gray bg-white p-5 shadow-sm shadow-charcoal/5">
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#E6F7F5] text-[#0D9488]">
                    ...
                    <div
                        ...
                        <div class="rounded-2xl border border-light-gray bg-white p-5 shadow-sm shadow-charcoal/5">
                            <div class="mb-4 flex items-center justify-between">
                                ...
                                <a href="#" class="text-xs font-semibold text-[#0D9488] hover:underline">View
                                    all</a>
                            </div>
